...
import backgroundImg from "../../assets/MeetingWhyus.jpg";
            ...
            >
                ...
                style={{
                   ...
                   <div className="w-full h-full flex flex-col">
                    ...
                    <div className="flex my-4 items-center gap-4">
                    <div className="w-auto h-auto"><div className=" p-2 bg-primary-300 rounded-full"><Fingerprint size={42} /></div></div>
                    <div className="mx-4 ">
