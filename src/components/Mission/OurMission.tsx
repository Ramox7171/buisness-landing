...
const OurMission = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="ourmission" className="md:mt-20 md:mb-40 w-full">
      ...
      <motion.div className="flex flex-col md:flex-row w-full justify-center items-center min-h-full"
        ...
        <div className="w-1/2 flex flex-col justify-center h-full ">
          ...
          {isAboveMediumScreens ? (
            <div className="flex flex-col w-[800px] bg-neutral-900">
            ...
            <div className="flex">
              <div className="flex items-center justify-between w-[400px] bg-neutral-700 hover: cursor-pointer hover:border hover:border-primary-300 "> <img src={biznes} className="w-[150px]" /><div className="flex flex-col w-full px-4 text-white gap-3"><p className="text-xl font-bold">{strings.missionMeetingBig}</p><p>{strings.missionMeetingSmall}</p></div></div>
              <div className="flex items-center justify-between w-1/2 bg-neutral-800 hover:cursor-pointer hover:border hover:border-primary-300"><div className="flex flex-col px-4 text-white gap-3"><p className="text-xl font-bold">{strings.missionConsulBig}</p><p>{strings.missionConsulSmall}</p></div><img src={consultant} className="w-[150px]" /></div>
            ...
            <div className="flex flex-col w-full gap-4 min-h-screen md:py-2 p-0 text-white">
